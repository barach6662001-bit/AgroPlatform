...
const en: Translations = {
  ...
  fields: {
    ...
    tabNdvi: 'NDVI',
    ndviAnalyze: 'Analyze',
    ndviDetected: 'Detected {n} problem zones',
    ndviNoProblems: 'No problem zones detected',
    ndviLegendLow: 'Low NDVI (< 0.3)',
    ndviLegendMid: 'Medium NDVI (0.3–0.6)',
    ndviLegendHigh: 'High NDVI (> 0.6)',
    ndviDescription: 'Field vegetation analysis using the NDVI index',
    ndviAnalyzing: 'Analyzing...',
    cropName: 'Crop',
    variety: 'Variety',
