...
const en: Translations = {
  ...
  permissionsPage: {
    ...
    auditNoteTitle: 'Audit Reference Only',
    auditNoteMessage: 'These records are used for documentation and audit purposes only. Actual access control is enforced server-side by user role (Administrator, Manager, Operator, etc.) and is not affected by values in this table.',
    roleIdPlaceholder: 'Role ID (GUID)',
    roleNamePlaceholder: 'Role name (optional)',
    loadButton: 'Load',
    saveButton: 'Save',
    resetButton: 'Reset',
