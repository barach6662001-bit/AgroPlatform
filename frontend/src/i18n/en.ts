...
const en: Translations = {
  ...
  analytics: {
    ...
    salaryFuelTitle: 'Salary & Fuel Analytics',
    salaryFuelSubtitle: 'KPIs and breakdown of labour and fuel costs for the year',
    totalSalaryPaid: 'Salary Paid',
    totalAccruedWages: 'Wages Accrued',
    totalFuelLiters: 'Fuel Consumed (L)',
    totalLaborHours: 'Hours Worked',
    litersPerHa: 'L/ha',
    haPerHour: 'ha/hr',
