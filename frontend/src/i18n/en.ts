...
const en: Translations = {
  ...
  economics: {
    ...
    breakEvenSubtitle: 'Minimum yield required to cover costs per field',
    breakEvenPriceLabel: 'Price per tonne (UAH)',
    breakEvenPricePlaceholder: 'Enter price',
    breakEvenMinYield: 'Min. Yield (t/ha)',
    breakEvenLoadError: 'Error loading break-even data',
    breakEvenNoPrice: 'Enter price per tonne to calculate break-even yield',
    breakEvenNoCosts: 'No costs recorded',
  },
  costCategories: {
    Seeds: 'Seeds',
