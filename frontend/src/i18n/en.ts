...
const en: Translations = {
  ...
  auth: {
    ...
    featureFieldManagement:    'Cut grain losses with precise field-to-elevator tracking',
    featureGpsMonitoring:      'Monitor fuel consumption and equipment hours in real time',
    featureStorageManagement:  'Track every ton of grain — receipt, storage, sales',
    featureAnalyticsAndReports:'P&L per field — see margins in 2 clicks',
    heroTitle: 'Full control over your agribusiness',
    heroSubtitle: 'From field to elevator — accounting, finance, grain, equipment in one platform',
    platformSubtitle: 'Agribusiness management platform',
    tryDemo: 'Try demo →',
  },
  roles: {
