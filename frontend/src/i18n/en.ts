...
const en: Translations = {
  ...
  marginality: {
    title: 'Crop Marginality Dashboard',
    subtitle: 'Actual, planned and projected margin per crop',
    year: 'Year',
    pricePerTonne: 'Price per tonne (UAH)',
    cropName: 'Crop',
    areaHa: 'Area (ha)',
    ...
    loadError: 'Failed to load marginality data',
    hintPrice: 'Enter price per tonne to calculate projection',
    totalActualMargin: 'Total Actual Margin',
    totalPlannedCosts: 'Total Planned Costs',
    totalProjectedMargin: 'Total Projected Margin',
  },
};
