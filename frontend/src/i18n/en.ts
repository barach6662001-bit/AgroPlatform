...
const en: Translations = {
  ...
  economics: {
    ...
    seasonSubtitle: 'Year-over-year key metrics analysis',
    seasonLoadError: 'Error loading season comparison',
    seasonEmpty: 'No data for the selected years',
    seasonYear: 'Year',
    ...
    seasonSelectYears: 'Select years to compare',
    seasonChartTitle: 'Revenue & Costs by Year',
    seasonBestYear: 'Best Year (margin)',
  },
  costCategories: {
    Seeds: 'Seeds',
