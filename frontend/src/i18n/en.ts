...
const en: Translations = {
  ...
  sales: {
    title: 'Sales',
    subtitle: 'Track grain sales and revenue',
    addSale: 'New Sale',
    editSale: 'Edit Sale',
    buyer: 'Buyer',
    buyerRequired: 'Enter buyer name',
    buyerPlaceholder: 'Company name or full name',
    contractNumber: 'Contract Number',
    contractPlaceholder: 'e.g. 2024/01',
    cropType: 'Crop Type',
    selectCropType: 'Select crop type',
    quantityTons: 'Quantity (t)',
    pricePerTon: 'Price (UAH/t)',
    totalAmount: 'Total (UAH)',
    saleDate: 'Date',
    paymentStatus: 'Payment Status',
    loadError: 'Error loading sales',
    createSuccess: 'Sale recorded',
    createError: 'Error saving sale',
    updateSuccess: 'Sale updated',
    updateError: 'Error updating sale',
    deleteSuccess: 'Sale deleted',
    deleteError: 'Error deleting sale',
    deleteConfirm: 'Delete this sale record?',
    ...
    kpiTopBuyer: 'Top Buyer',
    kpiTotalQty: 'Total Volume',
  },
  cropTypes: {
    Wheat: 'Wheat',
    Barley: 'Barley',
