...
const en: Translations = {
  ...
  budget: {
    ...
    nav: 'Budget',
    pvfTitle: 'Budget: Plan vs Fact',
    pvfSubtitle: 'Comparison of planned and actual spending by category',
    kpiTotalPlanned: 'Total Planned',
    kpiTotalActual: 'Total Actual',
    kpiVariance: 'Variance',
    kpiExecution: 'Overall Execution',
    colPlan: 'Plan (UAH)',
    colFact: 'Fact (UAH)',
    colVariance: 'Variance (UAH)',
    colExecution: 'Execution %',
    chartTitle: 'Plan vs Fact by Category',
    chartPlan: 'Plan',
    chartFact: 'Fact',
    noChartData: 'No budget data available',
  },
  maintenance: {
    title: 'Maintenance',
