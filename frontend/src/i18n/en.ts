...
const en: Translations = {
  ...
  economics: {
    ...
    marginalityTitle: 'Marginality',
    marginalitySubtitle: 'Revenue, costs and margin analysis by field and product',
    marginalityLoadError: 'Error loading marginality data',
    groupByField: 'By Field',
    ...
    noMarginalityData: 'No data to display. Add sales and cost records.',
  },
  costCategories: {
    Seeds: 'Seeds',
