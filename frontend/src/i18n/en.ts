...
const en: Translations = {
  ...
  fields: {
    ...
    tabMap: 'Map',
    tabVra: 'Var. Rate',
    vraTitle: 'Variable Rate Application Maps (VRA)',
    vraSubtitle: 'Based on NDVI and soil analysis data',
    vraAddMap: 'Create VRA Map',
    vraNoMaps: 'No variable rate application maps yet',
    vraMapName: 'Map Name',
    vraFertilizerName: 'Fertilizer / Product',
    vraYear: 'Year',
    vraNotes: 'Notes',
    vraZones: 'Zones',
    vraZoneIndex: '#',
    vraZoneName: 'Zone Name',
    vraNdviValue: 'NDVI',
    vraSoilOrganicMatter: 'Organic Matter (%)',
    vraSoilNitrogen: 'N (kg/ha)',
    vraSoilPhosphorus: 'P (kg/ha)',
    vraSoilPotassium: 'K (kg/ha)',
    vraAreaHectares: 'Area (ha)',
    vraRateKgPerHa: 'Rate (kg/ha)',
    vraColor: 'Color',
    vraAddZone: 'Add Zone',
    vraRemoveZone: 'Remove Zone',
    vraExportCsv: 'Export CSV',
    vraDeleteMap: 'Delete map?',
    vraCreateSuccess: 'VRA map created',
    vraCreateError: 'Failed to create VRA map',
    vraDeleteSuccess: 'VRA map deleted',
    vraDeleteError: 'Failed to delete VRA map',
    vraZonesRequired: 'Add at least one zone',
    vraTotalArea: 'Total Area',
    vraWeightedRate: 'Weighted Rate',
    vraUnitKgPerHa: 'kg/ha',
    vraUnitHa: 'ha',
    vraUnitZones: 'zones',
    cropName: 'Crop',
    variety: 'Variety',
