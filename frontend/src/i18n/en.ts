...
const en: Translations = {
  ...
  fields: {
    ...
    soilNitrogen: 'Nitrogen (mg/100g)',
    soilPhosphorus: 'Phosphorus (mg/100g)',
    soilPotassium: 'Potassium (mg/100g)',
    soilSampleDepth: 'Sample Depth',
    soilLabName: 'Laboratory',
    addSoilAnalysis: 'Add Analysis',
    noSoilAnalyses: 'No soil analysis data yet',
