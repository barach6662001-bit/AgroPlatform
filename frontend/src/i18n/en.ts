...
const en: Translations = {
  ...
  fields: {
    ...
    yield: 'Yield',
    ndviLoad: 'Load image',
    ndviLoadError: 'Failed to load NDVI image',
    ndviNoGeometry: 'The field has no geometry. Draw the field boundary on the Map tab.',
    ndviHint: 'Select a date and click "Load image" to fetch the NDVI satellite image.',
