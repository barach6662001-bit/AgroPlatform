...
// Soil Analyses
export const getSoilAnalyses = (fieldId: string, year?: number) =>
  apiClient.get<SoilAnalysisDto[]>(`/api/fields/${fieldId}/soil-analyses`, { params: year ? { year } : undefined }).then((r) => r.data);
