...
public class ReceiptStockValidatorTests
{
    ...
    {
        var command = new ReceiptStockCommand(Guid.Empty, Guid.NewGuid(), null, 10m, "kg", null, null, null, null, null, null, null, null);
        var result = _validator.TestValidate(command);
    ...
    {
        var command = new ReceiptStockCommand(Guid.NewGuid(), Guid.Empty, null, 10m, "kg", null, null, null, null, null, null, null, null);
        var result = _validator.TestValidate(command);
    ...
    {
        var command = new ReceiptStockCommand(Guid.NewGuid(), Guid.NewGuid(), null, 0m, "kg", null, null, null, null, null, null, null, null);
        var result = _validator.TestValidate(command);
    ...
    {
        var command = new ReceiptStockCommand(Guid.NewGuid(), Guid.NewGuid(), null, -5m, "kg", null, null, null, null, null, null, null, null);
        var result = _validator.TestValidate(command);
        result.ShouldHaveValidationErrorFor(x => x.Quantity);
    }
    ...
    {
        var command = new ReceiptStockCommand(Guid.NewGuid(), Guid.NewGuid(), null, 10m, "", null, null, null, null, null, null, null, null);
        var result = _validator.TestValidate(command);
    ...
    {
        var command = new ReceiptStockCommand(Guid.NewGuid(), Guid.NewGuid(), null, 10m, new string('k', 21), null, null, null, null, null, null, null, null);
        var result = _validator.TestValidate(command);
        result.ShouldHaveValidationErrorFor(x => x.UnitCode);
    }
}
