        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    N = table.Column<decimal>(type: "numeric(10,4)", precision: 10, scale: 4, nullable: true),
                    P = table.Column<decimal>(type: "numeric(10,4)", precision: 10, scale: 4, nullable: true),
                    K = table.Column<decimal>(type: "numeric(10,4)", precision: 10, scale: 4, nullable: true),
