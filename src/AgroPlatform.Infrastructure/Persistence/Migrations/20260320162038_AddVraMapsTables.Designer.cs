...
namespace AgroPlatform.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260320162038_AddVraMapsTables")]
    partial class AddVraMapsTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AgroPlatform.Domain.Fields.VraMap", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("AgroPlatform.Domain.Fields.VraZone", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<decimal?>("SoilNitrogen")
                        .HasPrecision(8, 2)
                        .HasColumnType("numeric(8,2)");

                    b.Property<decimal?>("SoilOrganicMatter")
                        .HasPrecision(8, 2)
                        .HasColumnType("numeric(8,2)");

                    b.Property<decimal?>("SoilPhosphorus")
                        .HasPrecision(8, 2)
                        .HasColumnType("numeric(8,2)");

                    b.Property<decimal?>("SoilPotassium")
                        .HasPrecision(8, 2)
                        .HasColumnType("numeric(8,2)");
            ...
            modelBuilder.Entity("AgroPlatform.Domain.Fields.VraZone", b =>
                {
                    b.HasOne("AgroPlatform.Domain.Fields.VraMap", "VraMap")
                        .WithMany("Zones")
                        .HasForeignKey("VraMapId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
