...
namespace AgroPlatform.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260425093014_AddImpersonationRateLimitIndex")]
    partial class AddImpersonationRateLimitIndex
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AgroPlatform.Domain.Approval.ApprovalRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("AgroPlatform.Domain.Approval.ApprovalRule", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("AgroPlatform.Domain.Economics.ExchangeRate", b =>
                {
            ...
            modelBuilder.Entity("AgroPlatform.Domain.FeatureFlags.TenantFeatureFlag", b =>
                {
                    b.Property<Guid>("TenantId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("AgroPlatform.Domain.GrainStorage.GrainBatch", b =>
                {
                    ...
                    b.Property<decimal?>("GlutenPercent")
                        .HasPrecision(5, 2)
                        .HasColumnType("numeric(5,2)");

                    b.Property<decimal?>("GrainImpurityPercent")
                        .HasPrecision(5, 2)
                        .HasColumnType("numeric(5,2)");
            ...
            modelBuilder.Entity("AgroPlatform.Domain.Notifications.MobilePushToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("AgroPlatform.Domain.Seasons.Season", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("AgroPlatform.Domain.SuperAdmin.SuperAdminAuditLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("AgroPlatform.Domain.Users.RefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("AgroPlatform.Domain.Users.UserMfaSettings", b =>
                {
                    b.Property<string>("UserId")
                        .HasMaxLength(450)
                        .HasColumnType("character varying(450)");
            ...
            modelBuilder.Entity("AgroPlatform.Domain.Users.UserPreferences", b =>
                {
                    b.Property<string>("UserId")
                        .HasMaxLength(450)
                        .HasColumnType("character varying(450)");
            ...
            modelBuilder.Entity("AgroPlatform.Domain.FeatureFlags.TenantFeatureFlag", b =>
                {
                    b.HasOne("AgroPlatform.Domain.Users.Tenant", null)
                        .WithMany()
            ...
            modelBuilder.Entity("AgroPlatform.Domain.Users.UserMfaSettings", b =>
                {
                    b.HasOne("AgroPlatform.Domain.Users.AppUser", null)
                        .WithOne()
                        .HasForeignKey("AgroPlatform.Domain.Users.UserMfaSettings", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("AgroPlatform.Domain.Users.UserPreferences", b =>
                {
                    b.HasOne("AgroPlatform.Domain.Users.AppUser", null)
                        .WithOne()
                        .HasForeignKey("AgroPlatform.Domain.Users.UserPreferences", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
